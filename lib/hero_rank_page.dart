...
class _HeroRankPageState extends State<HeroRankPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ===========================================================
      // ⭐ BODY dibungkus Stack untuk menempelkan banner di bawah
      // ===========================================================
      body: Stack(
        children: [
          Positioned.fill(
...
class _HeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(context, shrinkOffset, overlapsContent) {
    return Container(
      ...
      child: const Row(
        children: [
          SizedBox(width: 50, child: Text('#', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
          Expanded(flex: 2, child: Text('Hero', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
          Expanded(child: Text('Pick Rate', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
          Expanded(child: Text('Win Rate', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
          Expanded(child: Text('Ban Rate', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
        ],
      ),
    );
  }
