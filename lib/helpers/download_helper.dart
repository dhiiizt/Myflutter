...
class DownloadHelper {
  ...
  /// - progress = 0.0–1.0
  static Future<bool> handleDownloadAndInstall1(
    String url, {
    ...
    try {
      ...
      final targetPath = '/storage/emulated/0/Android/data/$realPackage/files';
      bool moved = false;
      ...
      // 4b. SAF fallback (Android 11+)
        if (!moved) {
          ...
          if (uri != null) {
            ...
            onProgress?.call('move', 0.0);
            final success =
                await StorageHelper.copyDirectoryToSAF1(extractDir.path, uri);
